...
reference_melody = extract_melody_from_midi("data/input_midi/chpn_op7_1.mid")[:64]
...
agent = PolicyAgent(state_size=env.max_length * 2, action_size=env.action_space.n)

# Historik for træning og belønninger
avg_reward_history = []
window = 20
n_episodes = 2000  # antal episoder
reward_history = []
...
for episode in range(n_episodes):
    ...
    # Beregn glidende gennemsnit for belønninger
